...
public class WaitUntilAllRespondedMessageSpecification<R> implements IMessageSpecification {
    ...
    private WaitUntilAllRespondedMessageSpecification(@NonNull final Set<AID> agentsToWaitFor,
                                                      @NonNull final ACLMessage request,
    ...
    public MessageTemplate getTemplateToMatch() {
        return MessageTemplate.MatchConversationId(request.getConversationId());
    }
    ...
    public static <R> WaitUntilAllRespondedMessageSpecification<R> complexWithRegisterAndDeregister(final Set<AID> agentsToWaitFor,
        ...
        final WaitUntilAllRespondedMessageSpecification<R> spec = new WaitUntilAllRespondedMessageSpecification<>(agentsToWaitFor, request, mapper, messageHandler::remove, doAfterFinishAndDeregister, Duration.ofSeconds(5));
